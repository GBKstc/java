			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title=""
						class="medium"
						src="${pageContext.request.contextPath}/${sessionScope.pro.pimage}">
				</div>

				<div class="col-md-6">
					<div>
						<strong>${sessionScope.pro.pname}</strong>
					</div>
					<div
						style="border-bottom: 1px dotted #dddddd; width: 350px; margin: 10px 0 10px 0;">
						<div>编号：${sessionScope.pro.pid}</div>
					</div>

					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${sessionScope.pro.shop_price}元/份</strong> 参 考 价：
						<del>￥${sessionScope.pro.market_price}元/份</del>
					</div>
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:;"> <input
								...
								value="加入购物车" type="button" onclick='main.shop()'>
							</a> &nbsp;收藏商品
						</div>
					</div>
				</div>
...
<script>
	var main = {
			...
			shop:function(){
				...
				location.href="${pageContext.request.contextPath}/shoppingCart?buyNum="+num;
			},
	}
</script>
</html>