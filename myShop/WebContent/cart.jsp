	...
	<body>
		...
		<div class="container">
						...
						<tbody>
							...
							<c:forEach items="${sessionScope.cart.cartItems}" var="entry">
								<tr class="active">
									...
									<td>
										<a href="${pageContext.request.contextPath}/deleteCartList?pid=${entry.value.product.pid}" class="delete">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">${sessionScope.cart.total}</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${sessionScope.cart.total}元</strong>
				</div>
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath}/deleteCartList" id="clear" class="clear">清空购物车</a>
