 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://service.gbk.demo.cn/", wsdlLocation = "http://localhost:12001/crf_service/service/cxfService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://service.gbk.demo.cn/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:12001/crf_service/service/cxfService?wsdl");
    ...
    public CustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://service.gbk.demo.cn/", "CustomerServiceImplPort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.gbk.demo.cn/", "CustomerServiceImplPort"), CustomerService.class, features);
    }
